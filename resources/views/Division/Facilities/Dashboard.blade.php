        ...
        <div id="dashboard-content" class="max-w-8xl mx-auto sm:px-6 lg:px-8 p-4 bg-[#F8FAFC]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
                <div
                    ...
                    <p class="text-4xl font-bold text-[#1E3A5F] mt-2">{{ $stats['total'] }}</p>
                ...
                <div
                    ...
                    <p class="text-4xl font-bold text-amber-600 mt-2">{{ $stats['pending'] }}</p>
                ...
                <div
                    ...
                    <p class="text-4xl font-bold text-blue-600 mt-2">{{ $stats['in_progress'] }}</p>
                ...
                <div
                    ...
                    <p class="text-4xl font-bold text-[#22C55E] mt-2">{{ $stats['completed'] }}</p>
