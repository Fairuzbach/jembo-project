    ...
    <div x-show="showEditModal" style="display: none;" x-data="{
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <div x-show="showEditModal" x-transition:enter="ease-out duration-300"
                ...
                class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-2xl transition-all sm:my-8 w-full sm:max-w-6xl border-t-8 border-indigo-600 flex flex-col max-h-[90vh]">

                {{-- Alert Error --}}
                @if (session('error'))
                    <div
                        class="m-4 mb-0 bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg relative flex items-center gap-3 shadow-sm">
                ...
                <div class="px-6 py-4 bg-white border-b border-slate-200 flex justify-between items-center shrink-0">
                    <div>
                        <h2 class="text-xl font-extrabold text-slate-800">Edit Matriks Compound</h2>
                    ...
                    <button type="button" @click="showEditModal = false"
                        class="text-slate-400 hover:text-rose-500 bg-slate-100 hover:bg-rose-50 rounded-full p-2 transition-colors">
                ...
                <div class="p-4 sm:p-6 bg-slate-50 overflow-y-auto grow">
                    <form id="formEditCompound" action="{{ route('eng.compound.update', [$plant->id ?? 0, $tanggal]) }}"
                                                ...
                                                <tbody class="divide-y divide-slate-200">
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($key == 6)
                                                            <td class="p-3 align-top bg-indigo-50/30">
                                                                @php
                                                                    $val = isset($dataExisting->ann_konsentrasi_2)
                                                                        ? str_replace(
                                                                            '%',
                                                                            '',
                                                                            $dataExisting->ann_konsentrasi_2,
                                                                        )
                                                                        : '';
                                                                @endphp
                                                                <select
                        ...
                        <div
                            class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-end border-t border-slate-200 pt-6">
                            <div>
                                    ...
                                    <div class="flex border-b-2 border-slate-800">
                                        <div
                                            ...
                                            <input type="text" x-model="operatorNik"
                                                ...
                                                class="mt-1.5 text-[10px] p-1 border-rose-300 rounded focus:ring-rose-500 font-bold uppercase w-full shadow-sm">
                                        </div>
                                        <div
                                            ...
                                            {{-- Info Pembuat Laporan Sebelumnya --}}
                                            <span
                        ...
                        {{-- SUBMIT BAR (Di dalam Modal Body agar ikut terscroll jika di HP) --}}
                        <div
                            class="mt-8 pt-4 border-t border-slate-200 flex justify-end gap-3 sticky bottom-0 bg-slate-50/90 backdrop-blur-sm -mx-6 px-6 pb-2">
                            <button type="button" @click="showEditModal = false"
                                class="px-5 py-2.5 text-sm font-bold text-slate-600 bg-white border border-slate-300 rounded-xl hover:bg-slate-100 transition-all">
                                Batal
                            </button>
                            <button type="submit"
                                ...
                                class="px-8 py-2.5 rounded-xl font-bold text-sm shadow-md transition-all active:scale-95 flex items-center gap-2">
