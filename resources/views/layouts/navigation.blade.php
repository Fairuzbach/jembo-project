            ...
            <div class="flex">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    @if (auth()->check() && auth()->user()->role === 'eng.admin')
                        {{-- Tombol Statistik --}}
                        <a href="{{ route('eng.compound.stats') }}"
                            class="flex items-center px-4 py-2 mt-1 text-sm font-bold text-slate-600 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition-colors {{ request()->routeIs('eng.compound.stats') ? 'bg-blue-50 text-blue-700' : '' }}">
                        ...
                        {{-- Tombol Master Standar --}}
                        <a href="{{ route('eng.compound.standards') }}"
                            class="flex items-center px-4 py-2 mt-1 text-sm font-bold text-slate-600 rounded-lg hover:bg-indigo-50 hover:text-indigo-700 transition-colors {{ request()->routeIs('eng.standards.*') ? 'bg-indigo-50 text-indigo-700' : '' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
