<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    {{-- LOGIC PHP: Tentukan Arah Home berdasarkan Route yang sedang aktif --}}
    @php
        $user = Auth::user();
        $homeRoute = '#'; // Default
        $isActive = false;

        // 1. CEK KONTEKS URL (Jika sedang di dalam module)
        if (request()->is('fh*')) {
        ...
        // 2. FALLBACK (Jika di halaman Admin / Profile / Netral)
        // Kita arahkan Home berdasarkan Divisi/Role User
        else {
            ...
            // isActive biarkan false, karena kita tidak sedang di dashboard utama
        }
    @endphp
